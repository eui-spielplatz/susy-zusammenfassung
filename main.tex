...
\[ \cos(\omega_0n)\ftransform \pi[\eta(\omega-\omega_0)+\eta(\omega+\omega_0)] \]
\[ \sin(\omega_0n) \ftransform\frac{\pi}{j}[\eta(\omega-\omega_0)-\eta(\omega+\omega_0)]\]
\[ \rect\left(\frac{n}{N}\right) \ftransform\frac{sin[\omega(2N+1)/2]}{sin(\omega/2)}\]
\[ \frac{\omega_g}{\pi} \sinc(\omega_gn) \ftransform \sum_{k=-\infty}^{\infty} \rect \left(\frac{\omega+2k\pi}{\omega_g}\right) \]
...
\[ \eta(\omega)=\sum_{k=-\infty}^{\infty}\delta(\omega+2k\pi) \]
\end{multicols}
\newpage
