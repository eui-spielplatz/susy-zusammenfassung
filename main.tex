...
\begin{longtable}{r >{\centering\arraybackslash} p{7cm} l}
	...
	\textbf{Dreieck} & $A ~ \dfrac{t}{T} ~ \rect \left(\dfrac{t-\frac{T}{2}}{\frac{T}{2}} \right)$ & \raisebox{-.5\height}{\includegraphics[width=3cm]{img/zeitkontDreieck}} \\
...
\[x(n)=1,2,3,4\qquad\qquad h(t)=1,2,1\]
\begin{center}
	\centering
