...
Die Abtastung eines zeitkontinuierlichen reellen Signals $x(t)$ ist genau dann eindeutig, wenn die Abtastfrequenz $f_{abtast}$ mehr als doppelt so groß ist, wie die maximale Frequenz $f_{max}$ von $x(t)$.
\[ f_{abtast} > 2*f_{max} \]
\subsection*{Aliasing}
