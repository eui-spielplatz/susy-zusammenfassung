...
\begin{document}
\section*{Klassifikation von Signalen und Systemen}
...
\begin{tabular}{r | r | p{11.5cm}}
	...
	& \textbf{nichtkausal} & $y(t)$ hängt von zukünftigen $x(t + a)$ ab \\
...
\begin{tabular}{l l p{12cm}}
	...
	\textbf{E3)}&\textbf{Distributiv} (Parallelschaltung) & $((x \ast h_1)(n)+(x \ast h_2)(n) = (x \ast (h_1 + h_2))(n)$
\end{tabular}
\begin{center}
	\centering
	\begin{tabular}{l | c | c | c |}
...
\fancyformula{Parsevalsche Gleichung}{
	\[ \frac{1}{T} \int_T |x(t)|^2 \mathrm dt = \sum_{k = -\infty}^{\infty} |c_k|^2 = a_0^2 + \frac{1}{2} \sum_{k=1}^{\infty} \left(|a_k|^2 + |b_k|^2 \right) \]
}
